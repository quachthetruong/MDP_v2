...
class TestError(MinerBaseV2):
    ...
    output_cfg:StreamCfg = StreamCfg(
        ...
        stream_fields=[
                      ...
                      ('quy', 'text'),
                      ('nam', 'text'),
                      ('doanhthuphibaohiem', 'text'),
                      ('phibaohiemgoc', 'text'),
                      ('phinhantaibaohiem', 'text'),
                      ('tgduphongphibaohiemgoc', 'text'),
                      ('phinhuongtaibaohiem', 'text'),
                      ('tongphinhuongtaibaohiem', 'text'),
                      ('tgduphongphinhuongtaibaohiem', 'text'),
                      ('cackhoangiamtrukhac', 'text'),
                      ('doanhthuphibaohiemthuan', 'text'),
                      ('hoahongnhuongtaibaohiem', 'text'),
                      ('thuhoahongnhuongtaibaohiem', 'text'),
                      ('thukhachdkdbaohiem', 'text'),
                      ('doanhthuthuan', 'text'),
                      ('chiboithuong', 'text'),
                      ('tongchiboithuong', 'text'),
                      ...
                      ('thuboithuongnhuongtaibaohiem', 'text'),
                      ...
                      ('tgduphongboithuongbaohiemgoc', 'text'),
                      ('tgduphongboithuongnhuongtaibaohiem', 'text'),
                      ('tongchiboithuongvatratienbaohiem', 'text'),
                      ('trichduphongdaodonglon', 'text'),
                      ('chikhachdkdbaohiemgoc', 'text'),
                      ('chihoahongbaohiemgoc', 'text'),
                      ...
                      ('tongchitructiephdkdbaohiem', 'text'),
                      ('lngop', 'text'),
                      ('lntuhdkdkhac', 'text'),
                      ('doanhthuhdkdkhac', 'text'),
                      ('cphdkdkhac', 'text'),
                      ('lnhdtaichinh', 'text'),
                      ('doanhthuhdtaichinh', 'text'),
                      ('chiphitaichinh', 'text'),
                      ...
                      ('thunhapkhac', 'text'),
                      ('chiphikhac', 'text'),
                      ('tonglnketoantruocthue_bs', 'text'),
                      ('chiphithuetndnhienhanh', 'text'),
                      ('chiphithuetndnhoanlai', 'text'),
                      ('lnstthunhapdn', 'text'),
                      ('loiichcuacodongthieuso', 'text'),
                      ('lnstcuacongtyme', 'text'),
    ...
    def __init__(self, target_symbols=['PVI', 'PRE']):
