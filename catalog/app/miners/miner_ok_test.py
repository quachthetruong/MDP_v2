...
class MinerOkTest(MinerBaseV2):
    ...
    output_cfg:StreamCfg = StreamCfg(
        ...
        stream_fields=[
                      ...
                      ('quy', 'text'),
                      ('nam', 'numeric'),
                      ('tm_taisantcniemyetdangkygdtaivsdcuactck', 'text'),
                      ('tm_taisantcdaluukytaivsdvachuagdcuactck', 'text'),
                      ('tm_taisantcchovecuactck', 'text'),
                      ('tm_taisantcchualuukytaivsdcuactck', 'text'),
                      ('tm_taisantcniemyetdangkygdtaivsd', 'text'),
                      ('tm_taisantcdaluukyvsdchuagdcuandt', 'text'),
                      ('tm_taisantcchovecuandt', 'text'),
                      ('tm_taisantcchualuukytaivsdcuandt', 'text'),
                      ('tm_tienguicuandt', 'text'),
                      ('tm_tienguivehoatdongmoigioick', 'text'),
                      ('tm_tienguicuandtvegdckctckql', 'text'),
                      ('tm_tiencuandtvegdcknhtmql', 'text'),
                      ('tm_tienguitonghopgdckcuandt', 'text'),
                      ('tm_tienguibutruthanhtoangdck', 'text'),
                      ('tm_tienguicuatochucphathanhck', 'text'),
                      ('tm_phaitrandtvetienguigdckctckql', 'text'),
                      ('tm_phaitrandttrongnuoctienguigdckctckql', 'text'),
                      ('tm_phaitrandtnuocngoaitienguigdckctckql', 'text'),
                      ...
                      ('tm_giatrighisotaisantcfvtpl', 'text'),
                      ('tm_cophieuniemyetfvtplghiso', 'text'),
                      ('tm_cophieuchuaniemyetfvtplghiso', 'text'),
                      ('tm_chungchiquyfvtplghiso', 'text'),
                      ('tm_traiphieufvtplghiso', 'text'),
                      ('tm_taisantckhacfvtplghiso', 'text'),
                      ('tm_giatrihoplytaisantcfvtpl', 'text'),
                      ('tm_cophieuniemyetfvtplhoply', 'text'),
                      ('tm_cophieuchuaniemyetfvtplhoply', 'text'),
                      ('tm_chungchiquyfvtplhoply', 'text'),
                      ('tm_traiphieufvtplhoply', 'text'),
                      ('tm_taisantckhacfvtplhoply', 'text'),
                      ('tm_giatrighisotaisantcafs', 'text'),
                      ('tm_cophieuniemyetafsghiso', 'text'),
                      ('tm_cophieuchuaniemyetafsghiso', 'text'),
                      ('tm_chungchiquyafsghiso', 'text'),
                      ('tm_traiphieuafsghiso', 'text'),
                      ('tm_taisantckhacafsghiso', 'text'),
                      ('tm_giatrihoplytaisantcafs', 'text'),
                      ('tm_cophieuniemyetafshoply', 'text'),
                      ('tm_cophieuchuaniemyetafshoply', 'text'),
                      ('tm_chungchiquyafshoply', 'text'),
                      ('tm_traiphieuafshoply', 'text'),
                      ('tm_taisantckhacafshoply', 'text'),
                      ('tm_giatrighisotaisantchtm', 'text'),
                      ('tm_traiphieuhtm', 'text'),
                      ('tm_congcuthitruongtientehtm', 'text'),
                      ('tm_taisantckhachtm', 'text'),
                      ('tm_cackhoanchovayvaphaithu', 'text'),
                      ('tm_chovaynghiepvukyquymargin', 'text'),
                      ('tm_chovayungtruoctienbanckcuakhachhang', 'text'),
                      ('tm_phaithukhac', 'text'),
                      ('donvikiemtoan', 'text'),
                      ('ykienkiemtoan', 'text'),
                      ('Error', 'text'),
