...
async def request_validation_exception_handler(request: Request, exc: RequestValidationError) -> JSONResponse:
    ...
    """
    logger.info("Our custom request_validation_exception_handler was called")
...
async def http_exception_handler(request: Request, exc: HTTPException) -> Union[JSONResponse, Response]:
    ...
    """
    logger.info("Our custom http_exception_handler was called")
...
async def unhandled_exception_handler(request: Request, exc: Exception) -> PlainTextResponse:
    ...
    """
    logger.info("Our custom unhandled_exception_handler was called")
    ...
    return PlainTextResponse(str(exc), status_code=300)
